...
import 'CompletedBookingUserTracking.dart';
...
class _CompletedBookingsPageState extends State<CompletedBookingsPage> {
                  ...
                  return Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            Colors
                                .black45, // background color of the rounded shape
  ...
  Widget _buildBookingCard(Map<String, dynamic> booking) {
    ...
    final double? locationLatitude =
        latString != null ? double.tryParse(latString) : null;

    final double? locationLongitude =
        lonString != null ? double.tryParse(lonString) : null;
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder:
                (_) => CompletedBookingUserTracking(
